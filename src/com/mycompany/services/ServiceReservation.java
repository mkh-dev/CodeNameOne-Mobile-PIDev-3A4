...
//    
//     public Reservation getResBYid(int numRes) throws IOException {
//      String url = "http://127.0.0.1:8000/ResJ/" + numRes;
//    req.setUrl(url);
//    req.setPost(false);
...
//                        String nomuser = offreMap.get("iduser").toString();                        
//                        String nomevent = offreMap.get("idEvent").toString();                        
//                        int nbPlaces = Integer.parseInt(offreMap.get("nbp").toString());                
//         System.out.println(id);
//          fr.setNumRes((int)id);
//          fr.setIdUser(nomuser);
//            fr.setIdEvent(nomevent);
//            fr.setNbPlaces(nbPlaces);
//
//
