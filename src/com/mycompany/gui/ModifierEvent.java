...
public class ModifierEvent extends BaseForm{
    ...
    public ModifierEvent(Resources res, Evenement rec) {
...
tb.addSearchCommand(e -> {
        ...
        TextField Nom = new TextField(rec.getNomEvent(), "Nom", 20, TextField.ANY);
        
                TextField prenom = new TextField(rec.getDescriptionEvent(), "Description", 20, TextField.ANY);
        TextField ville = new TextField(rec.getLieuEvent(), "Lieu", 20, TextField.ANY);
        ...
        btnModifier.addPointerPressedListener(l -> {
          rec.setNomEvent(Nom.getText());
                   rec.setDescriptionEvent(prenom.getText());
          rec.setLieuEvent(ville.getText());



            if (Service_Event.getInstance().ModifierEvent(rec)) {
