...
//       reserver.addActionListener(e -> {
//           ModifResForm.numres=lvs.getNumRes(); // Logger.getLogger(ReservationHome.class.getName()).log(Level.SEVERE, null, ex);
...
btnBack.addActionListener(e -> {
    ...
    new NewsfeedForm(theme).show(); // assuming ReservationHome is the name of your form
});
cn.add(btnBack);
