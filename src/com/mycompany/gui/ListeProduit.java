 ...
 * @author youss
 */
public class ListeProduit extends BaseForm{
    Form current;

    public ListeProduit(Resources res){
        
        super("ListeProduit",BoxLayout.y());
...
Button Share=new Button("Share");
 ...
 liste.addPointerPressedListener(l->{
    ...
    private void addButton(Image img, Produit art,Resources res) {
        ...
        Label titreTxt = new Label("Nom Produit : "+art.getNomProd(),"NewsTopLine2");
        
            Label titreTxt2 = new Label("Description : "+art.getDescription(),"NewsTopLine2");
            
             Label titreTxt3 = new Label("Nom Part : "+art.getNomPart(),"NewsTopLine2");


                  Label titreTxt4 = new Label("Prix : "+art.getPrix(),"NewsTopLine2");

                  Label titreTxt5 = new Label("Quantite : "+art.getQuantite(),"NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cet Produit ?","Annuler","Oui")){
                dig.dispose();
            }
            else{
                dig.dispose();
                
                if(Service_Produit.getInstance().deleteProduit(art.getIdProd())){
                    new ListeProduit(res).show();
        ...
        lModifier.addPointerPressedListener(l ->{
            System.out.println("");
          new ModifierProduit(res, art).show();
