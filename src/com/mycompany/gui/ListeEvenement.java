...
public class ListeEvenement extends BaseForm{
    ...
    public ListeEvenement(Resources res){
        ...
        super("ListeEvenement",BoxLayout.y());
        
        Toolbar tb = new Toolbar(true);
        current = this;
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Liste des Evenemnt");
        ...
        RadioButton mesListes = RadioButton.createToggle("Les Evnets", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Partager", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Evnets", barGroup);
...
Button Share=new Button("Share");
 ...
 liste.addPointerPressedListener(l->{
     Display.getInstance().execute("https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=http%3A%2F%2F127.0.0.1%3A8000%2Fequipe_mobile&display=popup&ref=plugin&src=share_button");
        ...
        ArrayList<Evenement>list = Service_Event.getInstance().findAll();
        
        for(Evenement art:list){
    ...
    private void addButton(Image img, Evenement art,Resources res) {
        ...
        Label titreTxt = new Label("Nom : "+art.getNomEvent(),"NewsTopLine2");
        
            Label titreTxt2 = new Label("Lieux : "+art.getLieuEvent(),"NewsTopLine2");

                  Label titreTxt3 = new Label("Description : "+art.getDescriptionEvent(),"NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cet Event ?","Annuler","Oui")){
                dig.dispose();
            }
            else{
                dig.dispose();
                
                if(Service_Event.getInstance().deleteEvent(art.getIdEvent())){
                    new ListeEvenement(res).show();
        ...
        lModifier.addPointerPressedListener(l ->{
            System.out.println("");
         new ModifierEvent(res, art).show();
