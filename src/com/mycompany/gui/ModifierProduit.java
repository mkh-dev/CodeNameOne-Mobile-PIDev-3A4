...
tb.addSearchCommand(e -> {
        ...
        TextField Nom = new TextField(rec.getNomProd(), "Nom Produit", 20, TextField.ANY);
        
                TextField prenom = new TextField(rec.getDescription(), "Description", 20, TextField.ANY);
        TextField ville = new TextField(rec.getNomPart(), "Nom Part", 20, TextField.ANY);
        ...
        btnModifier.addPointerPressedListener(l -> {
          rec.setNomProd(Nom.getText());
                   rec.setDescription(prenom.getText());
          rec.setNomPart(ville.getText());
